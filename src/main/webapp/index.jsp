...
<head>
  ...
  <title>Surya Shop · modern e‑commerce_Suryafile</title>
  ...
  <header>
    <div class="container header-inner">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <a href="#" class="brand">Surya<span class="accent">Shop</span></a>
      </div>
  ...
  <footer>
    <div class="container">
      <div class="footer-grid">
        <div>
          <strong style="font-size:1.2rem;color:var(--primary);">SuryaShop</strong>
      ...
      <div style="text-align:center;margin-top:28px;font-size:0.8rem;color:var(--muted);">© <span id="year"></span> SuryaShop. All rights reserved.</div>
    </div>
  </footer>
