...
<head>
  ...
  <title>teja Shop · modern e‑commerce_tejafile</title>
  ...
  <header>
    <div class="container header-inner">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <a href="#" class="brand">teja<span class="accent">Shop</span></a>
      </div>
  ...
  <footer>
    <div class="container">
      <div class="footer-grid">
        <div>
          <strong style="font-size:1.2rem;color:var(--primary);">tejaShop</strong>
      ...
      <div style="text-align:center;margin-top:28px;font-size:0.8rem;color:var(--muted);">© <span id="year"></span> tejaShop. All rights reserved.</div>
    </div>
  </footer>
