...
<head>
  ...
  <title>Sweety Shop · modern e‑commerce_Sweetyfile</title>
  ...
  <header>
    <div class="container header-inner">
      <div style="display:flex;align-items:center;gap:12px;">
        ...
        <a href="#" class="brand">Sweety<span class="accent">Shop</span></a>
      </div>
  ...
  <footer>
    <div class="container">
      <div class="footer-grid">
        <div>
          <strong style="font-size:1.2rem;color:var(--primary);">SweetyShop</strong>
      ...
      <div style="text-align:center;margin-top:28px;font-size:0.8rem;color:var(--muted);">© <span id="year"></span> SweetyShop. All rights reserved.</div>
    </div>
  </footer>
